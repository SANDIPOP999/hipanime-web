...
<head>
    <title>Hipanime - Official Hipanime Watch High Quality Anime Online Without Ads</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="robots" content="index,follow" />
    <meta http-equiv="content-language" content="en" />
     <meta name="title" content="Hipanime - Official Hipanime #1 Watch High Quality Anime Online Without Ads" />
    <meta name="description" content="Hipanime - Official Hipanime #1 Watch High Quality Anime Online Without Ads. You can watch anime online free in HD without Ads. Best place for free find and one-click anime." />
    <meta name="keywords" content="Hipanime, Hipanime anime, download anime, otakuu, watch anime online, free anime, anime stream, anime hd, english sub, kissanime, gogoanime, animeultima, 9anime, 123animes, vidstreaming, gogo-stream, animekisa, zoro.to, gogoanime.run, animefrenzy, animekisa" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="<?=$websiteUrl?>" />
    <meta property="og:title" content="Hipanime - Official Hipanime Watch High Quality Anime Online Without Ads" />
    <meta property="og:image" content="<?=$cdn?>/images/banner.webp" />
    <meta property="og:description "
        content="Hipanime - Official Hipanime #1 Watch High Quality Anime Online Without Ads. You can watch anime online free in HD without Ads. Best place for free find and one-click anime." />
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-HXXS6F6S97"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-HXXS6F6S97');
</script>
                    ...
                    <div class="mwt-content">
                        ...
                        <div class="mwh-logo">
                            <a href="<?=$websiteUrl?>/home" class="mwh-logo-div">
                                <img src="<?=$cdn?>/images/logo.webp" alt="Hipanime">
                            </a>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="mwb-2col">
                        <div class="mwb-left" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                            <h1 itemprop="name" class="mw-heading">Hipanime - The best site to watch anime online for Free</h1>
                            ...
                            <p>Just like free online movie streaming sites, anime watching sites are not created
                                equally,
                                some are better than the rest, so we've decided to build Hipanime to be one of the best
                                free
                                anime streaming site for all anime fans on the world. Also, We are just indexing api results. Blame Consumet api</p>
                            <h2>1/ What is Hipanime?</h2>
                            <p>Hipanime is a free site to watch anime and you can even download subbed or dubbed anime in
                            ...
                            <h2>3/ So what make Hipanime the best site to watch anime free online?</h2>
                            <p>Before building Hipanime, we've checked many other free anime sites, and learnt from them.
                                We
                                only keep the good things and remove all the bad things from all the competitors, to put
                                it
                                in our Hipanime website. Let's see how we're so confident about being the best site for
                                anime
                                streaming:</p>
                            <ul>
                                <li><strong>Safety:</strong> We try our best to not having harmful ads on Hipanime.
                                </li>
                                ...
                                <li><strong>Quality/Resolution:</strong> All titles are in excellent resolution, the
                                    best
                                    quality possible. Hipanime also has a quality setting function to make sure our users
                                    can
                                ...
                                <li><strong>Streaming experience:</strong> Compared to other anime streaming sites, the
                                    loading speed at hipanime is faster. Downloading is just as easy as streaming, you
                                    won't
                                ...
                                <li><strong>Updates:</strong> We updates new titles as well as fulfill the requests on a
                                    daily basis so be warned, you will never run out of what to watch on hipanime.
                                </li>
                                ...
                                <li><strong>Device compatibility:</strong> Hipanime works alright on both your mobile and
                            ...
                            <p>So if you're looking for a trustworthy and safe site for your Anime streaming, let's give
                                Hipanime a try. And if you like us, please help us to spread the words and do not forget
                                to
                                bookmark our site.</p>
                            <p>Thank you!</p>
                            <p>&nbsp;</p>
                        ...
                        <div class="mwb-right">
                            <div class="zr-connect zr-connect-list">
                                ...
                                <?php
                                  $ch = curl_init();
								  curl_setopt($ch, CURLOPT_URL, "$ani/meta/populer");
                                  ...
                                  foreach((array) $json as $key => $trending) { ?>
                                    <div class="item">
                                        <h4 class="item-name"><a href="<?=$websiteUrl?>/anime/<?=$trending['mal_id']?>"
                                                title="<?=$trending['title']?>"><?=$trending['title']?></a></h4>
                                        <div class="subject">
                                            <div><?=$trending['total_episodes']?></div>
                                        </div>
                                    </div>
                                <?php } curl_close($ch); ?>
                                </div>
        ...
        <div id="xfooter-about">
            <div class="container">
                <p class="copyright">© 2023
                     <a href="<?=$websiteUrl?>">Hipanime</a>. Frontend by akatsuki.
                </p>
            </div>
        </div>
        <!--End: Footer-->
