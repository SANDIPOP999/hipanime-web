...
<head>
    <title>About us - Hipanime</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="robots" content="index,follow" />
    <meta http-equiv="content-language" content="en" />
    <meta name="description"
        content="Hipanime is a Free anime streaming website which you can watch English Subbed and Dubbed Anime online with No Account and Daily update. WATCH NOW!" />
    <meta name="keywords"
    ...
    <meta property="og:title" content="DMCA - Hipanime" />
                ...
                <div class="container">
                    <div class="information_page-wrap medium-page">
                        ...
                        <article class="article-infor">
                            <h1 class="h2-heading">Hipanime</h1>
							<div class="c4-button">
                  <a href="https://telegram.me/Anime_Ocean_Network" class="btn btn-radius btn-focus"><i class="fa fa-sign-in-alt mr-2"></i>Hipanime</a>
                    </div>
                            ...
                            <p>&nbsp;</p>
                            <h2 class="h2-heading">Hipanime</h2>
<div class="c4-button">
                  <a href="" class="btn btn-radius btn-focus"><i class="fa fa-star mr-2"></i>Hipanime Discord</a>
                    </div>
                            <ul>
							
                                <li>Hipanime ɪs ᴀɴ ᴀɴɪᴍᴇ ᴄᴏᴍᴍᴜɴɪᴛʏ ᴡʜɪᴄʜ ɪs ᴀ sᴇʀᴠɪᴄᴇ ᴘʀᴏᴠɪᴅɪɴɢ ɴᴇᴛᴡᴏʀᴋ ғᴏʀ ᴀɴɪᴍᴇ ʀᴇʟᴀᴛᴇᴅ sᴛᴜғғs ᴀᴄʀᴏss ᴅɪғғᴇʀᴇɴᴛ ᴘʟᴀᴛғᴏʀᴍs.</li>
