...
<head>
    <title>Anime List on Hipanime</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Anime List on Hipanime">
    ...
    <meta property="og:title" content="Anime List on Hipanime">
    <meta property="og:description" content="Anime List on Hipanime in HD with No Ads. Watch anime online">
...
<body data-page="page_anime">
 ...
 curl_setopt($ch, CURLOPT_POST, true);
							curl_setopt	  curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
								  curl_setopt($ch, CURLOPT_HEADER, FALSE);
								  curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type: application/json"));
								  $AZPage = curl_exec($ch);
