...
<head>
    <title>Watch <?=$title['romaji']?> - Hipanime</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Watch <?=$title['romaji']?> - Hipanime" />
    <meta name="description" content="<?=substr($getAnime['description'],0, 90)?>.... Read More On Hipanime" />
    ...
    <meta property="og:title" content="Watch <?=$title['romaji']?> - Hipanime">
    <meta property="og:description" content="<?=substr($getAnime['description'],0, 90)?>.... Read More On Hipanime.">
    ...
    <meta property="twitter:title" content="Watch <?=$title['romaji']?> - Hipanime">
    <meta property="twitter:description" ontent="<?=substr($getAnime['description'],0, 90)?>.... Read More On Hipanime.">
