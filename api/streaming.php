...
$download = str_replace("Gogoanime", "Hipanime", $getEpisode['ep_download']);
...
<head>
    <title>Watch <?=$getEpisode['animeNameWithEP']?>on Hipanime</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Watch <?=$getEpisode['animeNameWithEP']?> on Hipanime">
    <meta name="description" content="<?=substr($getAnime['synopsis'],0, 150)?> ... at <?=$websiteUrl?>">
    <meta name="keywords" content="Hipanime, <?=$getEpisode['animeNameWithEP']?>,<?=$getAnime['name']?>, watch anime online, free anime, anime stream, anime hd, english sub">
    <meta name="charset" content="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1">
    <meta name="robots" content="index, follow">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta http-equiv="Content-Language" content="en">
    <meta property="og:title" content="Watch <?=$getEpisode['animeNameWithEP']?>on Hipanime">
    ...
    <meta property="twitter:title" content="Watch <?=$getEpisode['animeNameWithEP']?>on Hipanime">
                        ...
                        <div class="anis-watch-wrap">
                            ...
                            <div class="anis-watch anis-watch-tv">
                                <div class="watch-player">
                                    <div class="player-frame" style=" width: 100%; height: 100%; overflow: hidden; position: relative; ">
                                        ...
                                        <iframe name="iframe-to-load" id="iframeid" src="https://hipanime.ct.ws/player/v1.php?id=<?=$url?>&download=<?=$download?>" frameborder="0" height='100%' width="100%" top='0' bottom='0' right='0' left='0' scrolling="no" allow="accelerometer;autoplay;encrypted-media;gyroscope;picture-in-picture" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                                    </div>
                                ...
                                <div class="player-servers">
                                    <div id="servers-content">
                                        ...
                                        <div class="ps_-block ps_-block-sub servers-mixed">
                                            ...
                                            <div class="ps__-list">
											<div class="item">
                                                    <a id="server1" href="https://hipanime.ct.ws/player/v1.php?id=<?=$url?>&download=<?=$download?>" target="iframe-to-load" class="btn btn-server active">Server 1</a>
                                                </div>
                                                <div class="item">
                                                    <a id="server2" href="https://Hipanime.com/player/<?=$url?>" target="iframe-to-load" class="btn btn-server">Server 2</a>
                                                </div>
												
												<div class="item">
                                                    <a id="server3" href="https://the.Hipanime.com/player/v2.php?id=<?=$url?>" target="iframe-to-load" class="btn btn-server">Server 3</a>
                                                </div>
                            ...
                            <div class="anis-watch-detail">
                                <div class="anis-content">
                                    <div class="anisc-poster">
                                        <div class="film-poster">
                                            <img src="https://ik.imagekit.io/<?=$imgk?>/tr:w-200,f-webp/<?=$getAnime['imageUrl']?>"
                                                ...
                                                alt="Watch free online <?=$getAnime['name']?> on Hipanime">
                                        </div>
                                    </div>
                                    <div class="anisc-detail">
                                      ...
                                      <button onclick="saveToPlaylist('Anime List', '<?=$getAnime['name']?>', 'https://the.Hipanime.com/anime/<?=$url?>', 'https://ik.imagekit.io/<?=$imgk?>/tr:w-100,tr:f-webp/<?=$getAnime['imageUrl']?>');checkIfBookmarked('Anime List', '<?=$getAnime['name']?>')" id="save-to-playlist-button" class="btn btn-primary"><i
                                            class="fas fa-bookmark mr-2"></i>Watch later</button>
											<br>
											</br>
											
                                            Hipanime is a site to watch online anime like <strong><?=$getAnime['name']?></strong> online, or you can even watch <strong><?=$getAnime['name']?></strong> in HD quality
                                        </div>
...
checkIfBookmarked('Anime List', '<?=$getAnime['name']?> Ep <?=$getEpisode['ep_num']?>');
    ...
    <div id="footer-about">
        <div class="container">
            <div class="footer-top">
                ...
                <div class="footer-joingroup">
                    <div class="zoro-group">
                        <div class="zrg-title"><span class="top">Join now</span><span class="bottom">Hipanime
                                Groups</span></div>
                        <div class="zrg-list">
            ...
            <div class="about-text">Hipanime does not store any files on our server, we only share link to the
                media which is hosted on 3rd party services.</div>
           <p class="copyright">Served with <i class="fas fa-heart"></i> Hipanime 2023. Frontend by Otakatsu</p>
        </div>
    </div>
</div>
