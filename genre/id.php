...
<head>
    <title><?=$id?> on Hipanime</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="<?=$id?> on Hipanime">
    ...
    <meta property="og:title" content="<?=$id?> on Hipanime">
    <meta property="og:description" content="<?=$id?> on Hipanime in HD with No Ads. Watch anime online">
                                    ...
                                    <div class="flw-item">
                                        <div class="film-poster">
                                            ...
                                            <img class="film-poster-img lazyload"
                                                ...
                                                alt="Watch free online <?=$genreFetch['animeTitle']?> on Hipanime.com">
